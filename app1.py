...
CLIENT_ID = "6cea1127c8b24d51940c79241014b53e"
CLIENT_SECRET = "b32e3235eb7e4ecb881c6eebcb5de140"
...
def load_data():
    """
    Loads the pre-processed DataFrame and similarity matrix from pickle files.
    """
    try:
        ...
        st.error("Error: 'df.pkl' or 'similarity.pkl' not found.")
        st.write("Please make sure the `df.pkl` and `similarity.pkl` files from your notebook are in the same directory as `app.py`.")
        return None, None
    except Exception as e:
